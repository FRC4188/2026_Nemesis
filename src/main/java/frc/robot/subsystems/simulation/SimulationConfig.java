...
public class SimulationConfig {
  ...
  public static Pose3d hoodAxis =
      new Pose3d(
          Units.inchesToMeters(-9.625000),
          Units.inchesToMeters(9.00780 - 2.855782),
          Units.inchesToMeters(14.64837 - 0.142798),
          new Rotation3d(0, 0, 0));
  ...
  public static Pose3d indexer =
      new Pose3d(
          0,
          Units.inchesToMeters(7.625000 - 0.125000),
          Units.inchesToMeters(3.877500),
          new Rotation3d());
