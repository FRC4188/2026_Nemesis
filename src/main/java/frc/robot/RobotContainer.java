    ...
    autoChooser.addOption(
        ...
        Commands.sequence(
            ...
            Commands.sequence(
                ...
                PathBuilder.path(
                    new PathBuilder.Target(new Pose2d(2.975, 1.545, Rotation2d.kZero)),
                    // new PathBuilder.Target(new Pose2d(FieldConstants.Tower.right_approach_pos,
                    // Rotation2d.kZero), 0.2),
                    new PathBuilder.Target(
                        new Pose2d(
                            FieldConstants.Tower.right_intermediate_approach_pos, Rotation2d.kZero),
                        0.2),
                    new PathBuilder.Target(
                        new Pose2d(
                            FieldConstants.Tower.right_inter_inter_approach_pos, Rotation2d.kZero),
                        0.2),
                    new PathBuilder.Target(
