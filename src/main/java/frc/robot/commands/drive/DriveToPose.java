...
public class DriveToPose extends Command {
  ...
  public DriveToPose(Drive driveSubsystem, Supplier<Translation2d> t2dSupplier, Supplier<Rotation2d> headTarget) {
  ...
  public void execute() {
    ...
    thetaErrorAbs =
        Math.abs(currentPose.getRotation().minus(rotSupplier.get()).getRadians());
