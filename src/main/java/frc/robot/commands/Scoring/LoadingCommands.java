...
public class LoadingCommands {
  ...
  public static Command pivot(Loader loader, Rotation2d angle) {
    return Commands.runOnce(() -> loader.setWrist(angle), loader);
  }

  public static Command load(Loader loader, double volt) {
    return Commands.runOnce(() -> loader.intake(volt), loader);
  }

  public static Command aggitate(Transfer transfer, double volt) {
