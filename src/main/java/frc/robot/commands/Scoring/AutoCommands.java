  ...
  public static Command pseudoBoard(Start start, Swipe swipe, Cycle cycle) {
    if (cycle == Cycle.NONE) {
        ...
        PathBuilder.path(
            ...
            ).withRotationLead(0.5).withCurve(0)
        )
        );
    }
